			...
			<table class="table bg">
				...
				<tbody class="f24">
					<tr v-for="item in items">
						...
						<td><a class="subs" @click="sub(item)"></a><input type="text" v-model="item.RecommendOnShelvesAmount" :value="item.FullAmount" size="5" maxlength="5" @keyup='item.RecommendOnShelvesAmount=item.RecommendOnShelvesAmount.replace(/\D/gi,"")' /><a class="add" @click="add(item)"></a></td>
					</tr>
				</tbody>
